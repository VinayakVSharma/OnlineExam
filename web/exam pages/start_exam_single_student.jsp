<%-- 
    Document   : start_exam_single_student
    Created on : 22 Jun, 2017, 3:46:51 PM
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>                            
                            ...
                            <li class="active"><a href="start_exam_single_student.jsp"><span class="fa fa-sort-alpha-desc"></span>Start Exam Single Student</a></li>                                                        
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Start Exam Of Dynamically Added Student</h3>
                                </div>
                                <div class="panel-body">

                                    <form action="../controller/exam/exam_start_single_student.jsp" method="post" >  
                                        <input type="hidden" name="roll" value="<%= request.getParameter("roll")%>" />
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Select Student</label>
                                            <div class="col-md-6 col-xs-12">                                                                                            
                                                <select class="form-control select" name="ename">
                                                    <%
                                                        try {
                                                            s = sf.openSession();
                                                    ...
                                                    <%
                                                                    ...
                                                                    response.sendRedirect("start_exam_single_student.jsp?result=-----Data_Not_Found-----");
                                                                }
                                                            } else {
                                                                System.out.println("-----Query Is Blank-----");
                                                                response.sendRedirect("start_exam_single_student.jsp?result=-----Query_Is_Blank-----");
                                                            }
                                                        } catch (Exception e) {
                                                            e.printStackTrace();
                                                        } finally {
                                                ...
                                                <span class="help-block">Select The Student</span>
                                            </div>
                                        </div>
                                        <div class="panel-footer" class="col-xs-3">                                   
                                            <button class="btn btn-primary pull-right" name="start_exam" value="start_exam">Start Exam</button>
                                        </div>
                                    </form>                                
                                </div>
                            </div>
