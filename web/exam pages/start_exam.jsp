            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>                            
                            <li class="active"><a href="start_exam.jsp"><span class="fa fa-sort-alpha-desc"></span>Start Exam</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Exam Name</h3>
                                </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%= ar.getEname()%></td>
                                                <td>
                                                    <button class="btn btn-danger btn-rounded btn-sm" onclick="window.location.href = '../controller/exam/exam_start.jsp?ename=<%= ar.getEname()%>'">Start Exam</button>
                                                </td>
                                            </tr>
                                            <%
                                                            }
                                                            ...
                                                            response.sendRedirect("start_exam.jsp?result=-----Data_Not_Found-----");
                                                        }
                                                    } else {
                                                        System.out.println("-----Query Is Blank-----");
                                                        response.sendRedirect("start_exam.jsp?result=-----Query_Is_Blank-----");
                                                    }
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                } finally {
