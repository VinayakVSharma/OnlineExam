                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>                            
                            ...
                            <li class="active"><a href="end_exam.jsp"><span class="fa fa-sort-alpha-desc"></span>End Exam</a></li>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><%= ar.getEname()%></td>
                                                <td>
                                                    <button class="btn btn-default" onclick="window.location.href = '../controller/exam/exam_end.jsp?ename=<%= ar.getEname()%>'">End Exam</button>
                                                </td>
                                            </tr>
                                            <%
                                                            }
                                                            ...
                                                            response.sendRedirect("end_exam.jsp?result=-----Data Not Found-----");
                                                        }
                                                    } else {
                                                        System.out.println("-----Query Is Blank-----");
                                                        response.sendRedirect("end_exam.jsp?result=-----Query Is Blank-----");
                                                    }
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                } finally {
