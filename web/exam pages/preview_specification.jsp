    ...
    <body>
        ...
        <%
            try {
                ...
                mm=0;
                mq=0;
                Query qr1=s.createQuery("from bean.Specification where spec_name='" + request.getParameter("specname")+"'");
       List li1 = qr1.list();
            ListIterator lit1 = li1.listIterator();
            while (lit1.hasNext()) {
                bean.Specification spec = (bean.Specification) lit1.next();
                mm=mm+Integer.parseInt(spec.getTotal());
                mq=mq+Integer.parseInt(spec.getMk1())+Integer.parseInt(spec.getMk2())+Integer.parseInt(spec.getMk4())+Integer.parseInt(spec.getMk8());
            }
%>
