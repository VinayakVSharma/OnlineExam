<%-- 
    ...
    Created on : Dec 19, 2016, 8:49:59 PM
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li><a href="admin_update_picture.jsp"><span class="fa fa-user"></span>Admin Profile Picture</a></li>
                            <li class="active"><a href="admin_display.jsp"><span class="fa fa-user"></span>View Admins</a></li>
                        </ul>
                    </li>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-default btn-rounded btn-sm" onclick="window.location.href = '../controller/admin/admin_update.jsp?username=<%= ar.getUsername()%>'"><span class="fa fa-pencil"></span></button>
                                                    <button class="btn btn-danger btn-rounded btn-sm" onclick="window.location.href = '../controller/admin/admin_delete.jsp?username=<%= ar.getUsername()%>'"><span class="fa fa-times"></span></button>
                                                </td>
                                            </tr>
                                            <%
                                                            }
                                                            ...
                                                            response.sendRedirect("admin_display.jsp?result=-----Data Not Found-----");
                                                        }
                                                    } else {
                                                        System.out.println("-----Query Is Blank-----");
                                                        response.sendRedirect("admin_display.jsp?result=-----Query Is Blank-----");
                                                    }
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                } finally {
