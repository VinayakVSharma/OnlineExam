<%-- 
    Document   : admin_update_picture
    Created on : 26 Jun, 2017, 10:45:23 PM
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        <a href="admin_update_picture.jsp"><span class="fa fa-cogs"></span> <span class="xn-text">Admin Settings</span></a>                        
                        <ul>
                            <li class="active"><a href="admin_update_picture.jsp"><span class="fa fa-user"></span>Admin Profile Picture</a></li>
                            <li><a href="admin_display.jsp"><span class="fa fa-user"></span>View Admins</a></li>
                        </ul>
                    </li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">     
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>File Upload Operations</strong></h3> 
                                    </div>
                                    <div class="tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Admin Image</a></li>
                                            <li><a href="#tab-second" role="tab" data-toggle="tab">Logo Image</a></li>
                                        </ul>
                                        ...
                                        <div class="panel-body tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab-first">
                                                ...
                                                <form action="../controller/admin/admin_image_upload.jsp" method="post" enctype="multipart/form-data">

                                                    <div class="form-group">
                                                        <label class="col-md-3 col-xs-12 control-label">Admin Image to Update </label>
                                                        <div class=" col-md-3">      
                                                            <input type="file" class="" data-preview-file-type="any" name="image" size="50" multiple="multiple" />
                                                            <span class="help-block">Select a Image to be Uploaded with Name (profile-photo.jpg)</span>
                                                        </div>
                                                    </div>

                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="admin_image" value="admin_image">Upload Image</button>
                                                    </div> 
                                            ...
                                            <div class="tab-pane" id="tab-second">
                                                ...
                                                <form action="../controller/admin/logo_image_upload.jsp" method="post" enctype="multipart/form-data">

                                                    <div class="form-group">
                                                        <label class="col-md-3 col-xs-12 control-label">Logo to Update </label>
                                                        <div class=" col-md-3">      
                                                            <input type="file" class="" data-preview-file-type="any" name="image" size="50" multiple="multiple" />
                                                            <span class="help-block">Select a Image to be Uploaded with Name (logo-gpn.jpg)</span>
                                                        </div>
                                                    </div>

                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="logo_image" value="logo_image">Upload Image</button>
                                                    </div> 
                ...
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="admin_login.jsp" class="btn btn-success btn-lg">Yes</a>
