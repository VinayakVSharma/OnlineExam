...
<%@page import="org.hibernate.SQLQuery"%>
    ...
    SQLQuery questions = s.createSQLQuery("Select * FROM (Select * From Question_Bank  Order By Dbms_Random.Random ) Where Unit_No='" + spec.getUnit_no() + "'  And Marks=1 and rownum<=" + spec.getMk1());
...
questions = s.createSQLQuery("Select * FROM (Select * From Question_Bank  Order By Dbms_Random.Random ) Where Unit_No='" + spec.getUnit_no() + "'  And Marks=2 and rownum<=" + spec.getMk2());
questions.addEntity(bean.Question_Bank.class);
questionlist.addAll(questions.list());
out.println("<br>The quesry for spec is :" + questionlist);
questions = s.createSQLQuery("Select * FROM (Select * From Question_Bank  Order By Dbms_Random.Random ) Where Unit_No='" + spec.getUnit_no() + "'  And Marks=4 and rownum<=" + spec.getMk4());
questions.addEntity(bean.Question_Bank.class);
questionlist.addAll(questions.list());
questions = s.createSQLQuery("Select * FROM (Select * From Question_Bank  Order By Dbms_Random.Random ) Where Unit_No='" + spec.getUnit_no() + "'  And Marks=8 and rownum<=" + spec.getMk8());
questions.addEntity(bean.Question_Bank.class);
questionlist.addAll(questions.list());
}
