...
<%-- 
    ...
    qr = s.createQuery("from bean.Student where branch='" + e.getBranch() + "' and year='" + b.getYear() + "'");
    List li = qr.list();
    ...
    out.println("The quesry for spec is :"+qr12);
    List li12 = qr12.list();
    ...
    out.println("The quesry for spec is :"+questionlist);
...
FileWriter fw = new FileWriter(path + student.getRoll_no() + ".xml");
