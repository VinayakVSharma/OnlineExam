<%-- 
    ...
    Created on : Mar 10, 2017, 12:02:12 PM
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>                            
                            ...
                            <li class="active"><a href="subject_display.jsp"><span class="fa fa-sort-alpha-desc"></span> View Subjects</a></li>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                                    ...
                                                    if (qr != null) {
                                                        ...
                                                        if (li != null) {
                                                            ...
                                                            while (lit.hasNext()) {
                                                                ...
                                                                System.out.println(ar.getC_code());
                                            ...
                                            <tr>
                                                ...
                                                <td><%=ar.getBranch()%></td>
                                                <td>
                                                    <button class="btn btn-default btn-rounded btn-sm" onclick="window.location.href = '../controller/subject/subject_update.jsp?c_code=<%= ar.getC_code()%>'"><span class="fa fa-pencil"></span></button>
                                                    <button class="btn btn-danger btn-rounded btn-sm" onclick="window.location.href = '../controller/subject/subject_delete.jsp?c_code=<%= ar.getC_code()%>'"><span class="fa fa-times"></span></button>
                                                </td>
                                            </tr>
                                            <%
                                                            }
                                                            ...
                                                            response.sendRedirect("subject_display.jsp?result=-----Data Not Found-----");
                                                        }
                                                    } else {
                                                        System.out.println("-----Query Is Blank-----");
                                                        response.sendRedirect("subject_display.jsp?result=-----Query Is Blank-----");
                                                    }
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                } finally {
