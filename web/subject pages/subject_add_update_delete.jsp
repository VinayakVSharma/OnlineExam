<%-- 
    Document   : subject_add_update_delete
    Created on : Mar 10, 2017, 12:11:07 PM
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>                            
                            <li class="active"><a href="subject_add_update_delete.jsp"><span class="fa fa-align-justify"></span>Add / Update / Delete</a></li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">     
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>Subject Operations</strong></h3> 
                                    </div>
                                    <div class="tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Add Subject</a></li>
                                            <li><a href="#tab-second" role="tab" data-toggle="tab">Update Subject</a></li>
                                            <li><a href="#tab-third" role="tab" data-toggle="tab">Delete Subject</a></li>
                                        </ul>
                                        ...
                                        <div class="panel-body tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab-first">
                                                ...
                                                <form action="../controller/subject/subject_add.jsp">
                                                    ...
                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="add_btn" value="add_btn">Add Subject</button>
                                                    </div>                                                  
                                            ...
                                            <div class="tab-pane" id="tab-second">
                                                ...
                                                <form action="../controller/subject/subject_update.jsp" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-xs-12">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                                <input type="text" class="form-control" value="" name="c_code"/>
                                                            </div>
                                                            <span class="help-block">Enter Course Code</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="update_btn_subject" value="update_btn">Update Subject</button>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="tab-third">
                                                ...
                                                <form action="../controller/subject/subject_delete.jsp">
                                                    ...
                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="delete_btn" value="delete_btn">Delete Subject</button>
                                                    </div>
