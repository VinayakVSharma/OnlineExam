<%-- 
    Document   : student_list_upload
    Created on : Feb 20, 2017, 11:47:47 PM
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="student_list_upload.jsp"><span class="fa fa-arrow-right"></span>List Upload</a></li>
                        </ul>
                    </li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Student List Upload</h3>
                                    </div>                               
                                    <form action="../controller/student/student_upload_list.jsp" method="post">
                                        <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Select a list to upload : </label>
                                            <div class=" col-md-3">   
                                                <input type="file" class="form-control" name="file_select" accept=".csv,.xls,.xlsx"/>
                                                <span class="help-block">Select a list to upload</span>
                                            </div>
                                        </div>                                    

                                        <div class="panel-footer" class="col-xs-3">                                   
                                            <button class="btn btn-primary pull-right" name="upload_list_btn" value="upload_list_btn">Upload List</button>
                                        </div> 
                                    </form>
