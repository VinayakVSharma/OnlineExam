<%-- 
    Document   : latest
    Created on : Feb 16, 2017, 9:32:57 PM
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li class="active"><a href="student_add_update_delete.jsp"><span class="fa fa-table"></span>Add / Update / Delete </a></li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">     
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>Student Operations</strong></h3> 
                                    </div>
                                    <div class="tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Add Student</a></li>
                                        ...
                                        <div class="panel-body tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab-first">
                                                ...
                                                <form action="../controller/student/student_add.jsp">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2"> 
                                                            ...
                                                            <span class="help-block">Enter Student Roll No</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">                                        
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <span class="help-block">Select Student Branch</span>
                                                        </div>                                            
                                                    </div>
                                                    ...
                                                    <div class="form-group">                                        
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <span class="help-block">Select Student Year</span>
                                                        </div>                                            
                                                    </div>
                                                    ...
                                                    <div class="form-group">                                        
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <span class="help-block">Enter Date of Birth | Format:-(dd/mm/yyyy)</span>
                                                        </div> 
                                                    </div>
                                                    ...
                                                    <div class="form-group">                                        
                                                        ...
                                                        <div class="col-md-2">
                                                            <select class="form-control select" name="dynordb">
                                                                <option value="yes">Start Student Exam Dynamically</option> 
                                                                <option value="no" selected>Add Student To Database</option>                                                               >
                                                            </select>
                                                            <span class="help-block">Select Why to Add the For</span>
                                                        </div>                                            
                                                    </div>

                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="add_btn" value="add_btn">Add Student</button>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="tab-second">
                                                ...
                                                <form action="../controller/student/student_update.jsp" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <span class="help-block">Enter Roll No</span>

                                                        </div>
                                                    </div>

                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="update_btn" value="update_btn">Update Student</button>
                                                    </div>                                                    
                                                </form>
                                            ...
                                            <div class="tab-pane" id="tab-third">
                                                ...
                                                <form action= "../controller/student/student_delete.jsp">
                                                    ...
                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="delete_btn" value="delete_btn">Delete Student </button>
                                                    </div> 
