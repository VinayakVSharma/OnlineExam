<%-- 
    ...
    Created on : Feb 11, 2017, 2:21:14 PM
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            ...
                            <li><a href="student_display.jsp"><span class="fa fa-arrow-right"></span>View Student</a></li>
                            <li class="active"><a href="student_file_upload.jsp"><span class="fa fa-arrow-right"></span>File Upload</a></li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">     
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>File Uplaod Operations</strong></h3> 
                                    </div>
                                    <div class="tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">File Uplaod</a></li>
                                            <li><a href="#tab-second" role="tab" data-toggle="tab">Images Upload</a></li>
                                            <li><a href="#tab-third" role="tab" data-toggle="tab">Signatures Upload</a></li>
                                        </ul>
                                        ...
                                        <div class="panel-body tab-content">
                                            ...
                                            <div class="tab-pane active" id="tab-first">
                                                ...
                                                <form action="../controller/student/student_file_upload.jsp" method="post" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label class="col-md-3 col-xs-12 control-label">Select a file to upload : </label>
                                                        <div class=" col-md-3">      
                                                            <input type="file" class="" name="file" size="50" multiple="multiple" />
                                                            <span class="help-block">Select a File to be Uploaded</span>
                                                        </div>                                                        
                                            ...
                                            <div class="tab-pane" id="tab-second">
                                                ...
                                                <form action="../controller/student/student_images_upload.jsp" method="post" enctype="multipart/form-data">

                                                    <div class="form-group">
                                                        <label class="col-md-3 col-xs-12 control-label">Select Images to upload </label>
                                                        <div class=" col-md-3">      
                                                            <input type="file" class="" data-preview-file-type="any" name="student_images" size="50" multiple="multiple" />
                                                            <span class="help-block">Select a Files to be Uploaded</span>
                                                        </div>
                                                    </div>

                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="student_images" value="student_images">Upload Images</button>
                                                    </div> 
                                            ...
                                            <div class="tab-pane" id="tab-third">
                                                <form action="../controller/student/student_sign_upload.jsp" method="post" enctype="multipart/form-data">

                                                    <div class="form-group">
                                                        <label class="col-md-3 col-xs-12 control-label">Select Signatures to Uplaod </label>
                                                        <div class=" col-md-3">      
                                                            <input type="file" class="" name="student_sign" size="50" multiple="multiple" />
                                                            <span class="help-block">Select a Files to be Uploaded</span>
                                                        </div>
                                                    </div>
                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="student_sign" value="student_sign">Upload Signatures</button>
                                                    </div> 
