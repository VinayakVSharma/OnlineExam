<%-- 
    ...
    Created on : 26 Jun, 2017, 10:50:56 PM
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable">
                        <a href="subject_add_update_delete.jsp"><span class="fa fa-table"></span> <span class="xn-text">Subject</span></a>
                        <ul>                            
                            <li><a href="subject_add_update_delete.jsp"><span class="fa fa-align-justify"></span>Add / Update / Delete</a></li>
                            <li><a href="subject_display.jsp"><span class="fa fa-sort-alpha-desc"></span> View Subjects</a></li>
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li class="active"><a href="../result pages/result_view.jsp"><span class="fa fa-image"></span>View Result</a></li>
                        </ul>
                    </li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">     
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>View Result</strong></h3> 
                                    </div>
                                    <div class="tabs">
                                        <ul class="nav nav-tabs" role="tablist">
                                           <!-- <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Single Student (DB)</a></li>-->
                                            <li><a href="#tab-second" role="tab" data-toggle="tab">Multiple Students (DB)</a></li>
                                            <li><a href="#tab-third" role="tab" data-toggle="tab">Single Student (XML)</a></li>
                                        </ul>

                                        <div class="panel-body tab-content">

                                          <!--  <div class="tab-pane active" id="tab-first">
                                                <form action="../controller/result/result_single_db.jsp">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2"> 
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" value="" name="rl_no"/>
                                                            </div>
                                                            <span class="help-block">Enter Student Roll No to View Result from DB</span>
                                                        </div>
                                                    </div>                                                 

                                                    <div class="panel-footer" class="col-xs-3">                                   
                                                        <button class="btn btn-primary pull-right" name="search_btn" value="search_btn">View Result</button>
                                                    </div>                                                  
                                            ...
                                            <div class="tab-pane active" id="tab-second">
                                                ...
                                                <form action="../controller/result/result_multiple_db.jsp" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-xs-12">
                                                            <div class="input-group">
                                                                ...
                                                                <select class="form-control select" name="exam_name">
                                                                 <%
                                                                ListIterator li=getQ_no.getename();
                                                                while (li.hasNext()) {
                                                                        String ename = (String)li.next();
                                                                        out.println("<option value=\""+ ename+"\">"+ ename+"</option> ");
                                                                        
                                                                    }
                                                                %>
                                                                </select>
                                                            </div>
                                                            <span class="help-block">Select Exam</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="tab-third">
                                                ...
                                                <form action="../controller/result/result_single_xml.jsp">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2"> 
                                                            ...
                                                            <span class="help-block">Enter Student Roll No to View Result from XML</span>
                                                        </div>
                                                    </div> 
