                                            ...
                                            <div class="form-group">                    
                                                ...
                                                <div class="col-md-6">
                                                    <div class="gallery" id="links">
                                                        <a class="gallery-item pull-right" href="../img/logo-gpn.jpg" data-gallery>
                                                            <button class="btn-lg btn-primary col-xs-12 pull-right"><i class="glyphicon glyphicon-picture form-control"></i></button> 
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
