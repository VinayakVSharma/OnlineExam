<%-- 
    Document   : questionbank_list_upload
    Created on : Feb 21, 2017, 2:48:43 PM
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>                            
                            ...
                            <li class="active"><a href="questionbank_list_upload.jsp"><span class="fa fa-download"></span>List Upload</a></li> 
                        </ul>
                    </li>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Question Bank Upload</h3>
                                    </div>                               
                                    <form action="../controller/question bank/question_upload_list.jsp" method="post">
